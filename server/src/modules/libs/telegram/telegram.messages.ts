...
export const MESSAGES = {
	...
	ENABLE_TWO_FACTOR:
		`🔐 Увімкніть Двофакторну аутентифікацію у налаштуваннях акаунта (2FA).\n\n` +
		`<a href="https://twitchcopy.com/account/settings">⚙️ Налаштування акаунта</a>\n\n`,
	VERIFY_CHANNEL:
		`✅ Ваш канал успішно підтверджено!` +
		`Ми раді повідомити, що ваш канал тепер офіційно підтверджено на TwitchCopy. Це означає, що ваш контент та акаунт пройшли перевірку і відповідають нашим стандартам спільноти.\n\n` +
		`Ви отримали значок підтвердження на своєму профілі, що допоможе вашим глядачам легко ідентифікувати ваш канал як офіційний та надійний. Це також може сприяти збільшенню довіри та залученості вашої аудиторії.\n\n` +
		`Дякуємо, що обрали TwitchCopy для вашого стрімінгового досвіду. Ми цінуємо вашу участь у нашій спільноті та бажаємо вам успіхів у ваших майбутніх трансляціях!`
}
